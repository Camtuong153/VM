...
cat << eof > ~/startxp.sh
am start -n com.realvnc.viewer.android/.MainActivity
...
wget -O /sdcard/VM/a.7z https://www.mediafire.com/file/xuv54r2pf1lkgup/Windows_XP_x64.7z/file?dkey=qzjpz8fxjjm&r=1113
pkg install p7z -y
